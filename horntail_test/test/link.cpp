...
DROGON_TEST(generate_link_accepts_target_custom_lifetime) { Guard guard(TEST_CTX); }

DROGON_TEST(generate_link_accepts_target_indefinite_lifetime) { Guard guard(TEST_CTX); }
